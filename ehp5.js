...
function appendPapersToDOM() {
  var pub = document.getElementById('pub'); // Change 'papersContainer' to your actual container ID
  var wp = document.getElementById('wp'); // Change 'papersContainer' to your actual container ID
