// Publications list for evanpiermont.github.io
//
...
var papers = [
...
},
   {
    ...
    rr: "",
    url: `pdfs/NTI.pdf`,
    abs: `A narrative is accepted only if it is plausible, that is, consistent with an agent's existing beliefs. We represent an agent's beliefs through a stringent implication relation, capturing the most conservative inferences the agent is willing to draw, and formalize this relation via an evidential structure that assigns each assertion a set of verifying and a set of falsifying states. We show that every relation admits such a representation. Dually, we define a lenient implication capturing the weakest inferences consistent with the agent's beliefs. We show that a narrative is plausible exactly when it lies between these two bounds. `,
    supp: ``,
    slides: `pdfs/NTI_slides.pdf`,
    lean: `https://raw.githubusercontent.com/evanpiermont/proofs/refs/heads/main/Proofs/NTI.lean`,
    kw: ['logic', 'language', 'axioms'],
 },
    {
    ...
    year: ``,
    journal: ``,
    rr: {j: `the Journal of Mathematical Economics`, s: 'Revise'},
